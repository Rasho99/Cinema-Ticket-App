          ...
          Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: TextFrave(text: 'Buy Ticket \$ 15.0', fontWeight: FontWeight.bold),
              ),
            ),
          ),
        ...
        child: BlocBuilder<CinemaBloc, CinemaState>(
          builder: (context, state) => 
            Container(
              ...
              decoration: BoxDecoration(
                color: state.time == time ? Colors.lightGreenAccent : Color(0xff4D525A),
                borderRadius: BorderRadius.circular(8.0)
              ),
      ...
      child: Padding(
        ...
        child: BlocBuilder<CinemaBloc, CinemaState>(
          builder: (context, state) => 
            ...
            width: 75,
            decoration: BoxDecoration(
              color: state.date == date.number ? Colors.lightGreenAccent : Color(0xff4A5660),
